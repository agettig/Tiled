...
<tileset version="1.10" tiledversion="1.10.0" name="terrain" tilewidth="64" tileheight="64" tilecount="44" columns="11">
 <editorsettings>
  <export target="../assets/jsons/terrain.json" format="json"/>
 </editorsettings>
 <image source="terrain/tileset.png" width="704" height="256"/>
